...
export default function App() {
  ...
  return (
    <>
      ...
      <Main>
        <Box>
          {/* {isLoading ? <Loader /> : <MoviesLists movies={movies} />}</Box> */}
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <MoviesLists movies={movies} onSelectMovie={handleSelectMovie} />
          )}
...
function MovieDetails({ selectdId, onCloseMovie, onAddWatched, watched }) {
    ...
    function () {
      async function getMovieDetails() {
        ...
        const res = await fetch(
          `http://www.omdbapi.com/?apikey=${KEY}&i=${selectdId}`
        );
